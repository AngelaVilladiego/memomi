    ...
    <div className="bg-default bg-repeat-y h-1000 flex flex-col items-center justify-start">
      ...
      <div className="mt-0 absolute top-5/12 rounded-lg w-5/6">
        ...
        <div className="absolute top-0 left-20 w-475">
          ...
          <div className="absolute top-200 left-47 w-375 h-500 flex flex-col items-center">
            ...
            <p className="font-sans text-center text-wrap text-memoblue-400 text-sm mb-2">
        ...
        <div className="absolute top-80 right-20 w-475">
          ...
          <img src={Pile} alt='pile1' className="absolute top-2.5 right-2.5"></img>
          <img src={Pile} alt='pile1' className="absolute top-0 right-5"></img>
        </div>
